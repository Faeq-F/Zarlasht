...
///
/// Holds all games managed by this server and waiting for a second player
///
...
///
/// The `state` list is the set of player markings in the boxes - left to right, top to bottom
///
pub type GameState {
