...
import pages/svg_elements.{cross, empty, github, moon, nought, replay, sun, tick}
...
pub fn random_github_test() {
  let random_class = int.random(9999) |> int.to_string
  github(random_class)
  |> should.equal(
    svg.svg(
      [
